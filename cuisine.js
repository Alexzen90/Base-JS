...
for(i = 0; i < data.length - 1; i++) {
  ...
  } else {accompagnements.push(element)}            //Pas besoin d'écrire la condition car c'est le cas qui s'éxecute si les 2 conditions en haut ne sont pas valides
}
...
for(i = 0; i < 10; i++) {
    ...
    var assaisonnement = assaisonnements[Math.floor(Math.random() * assaisonnements.length)]
    var accompagnement = accompagnements[Math.floor(Math.random() * accompagnements.length)]
